...
catalogo = Catalogo(host='jebus1.mysql.pythonanywhere-services.com', user='jebus1', password='niidea1986', database='jebus1$myapp')

# Carpeta para guardar las imagenes
# ruta_destino = './static/imagenes/'
ruta_destino = '/home/jebus1/mysite/static/img/'
